...
import icon from "../assets/navs/icon1.svg";
...
<path d="M11.9946 16H12.0036" stroke="#B2ABAB" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <LightIconHolder>
            <GreenCircle
            style={{
                backgroundColor:darkTheme?"" : "#34CAA5"
            }}
            dt={darkTheme}
            onClick={()=>{
                setDarkTheme(false)
  ...
  <g clip-path="url(#clip0_1826_464)" >
    <path d="M9 13.2188C11.33 13.2188 13.2188 11.33 13.2188 9C13.2188 6.67005 11.33 4.78125 9 4.78125C6.67005 4.78125 4.78125 6.67005 4.78125 9C4.78125 11.33 6.67005 13.2188 9 13.2188Z" fill={darkTheme? "#b2abab" : "white"} />
    <path d="M9 3.09345C8.53363 3.09345 8.15625 2.71564 8.15625 2.2497V1.40625C8.15625 0.940309 8.53363 0.5625 9 0.5625C9.46637 0.5625 9.84375 0.940309 9.84375 1.40625V2.2497C9.84375 2.71564 9.46637 3.09345 9 3.09345Z" fill={darkTheme? "#b2abab" : "white"}/>
    <path d="M13.7734 5.07056C13.5576 5.07056 13.3417 4.98816 13.1769 4.82336C12.8473 4.49387 12.8473 3.95964 13.1769 3.63015L13.7734 3.03369C14.103 2.7043 14.637 2.7042 14.9666 3.03379C15.2961 3.36328 15.2961 3.89751 14.9666 4.227L14.37 4.82346C14.2052 4.98816 13.9893 5.07056 13.7734 5.07056Z" fill={darkTheme? "#b2abab" : "white"}/>
    <path d="M16.5937 9.84375H15.75C15.2836 9.84375 14.9062 9.46594 14.9062 9C14.9062 8.53406 15.2836 8.15625 15.75 8.15625H16.5937C17.0601 8.15625 17.4375 8.53406 17.4375 9C17.4375 9.46594 17.0601 9.84375 16.5937 9.84375Z" fill={darkTheme? "#b2abab" : "white"}/>
    <path d="M14.37 15.2133C14.1541 15.2133 13.9382 15.131 13.7734 14.9662L13.1769 14.3698C12.8473 14.0403 12.8473 13.5061 13.1769 13.1766C13.5065 12.847 14.0404 12.8469 14.37 13.1765L14.9666 13.7729C15.2961 14.1024 15.2961 14.6366 14.9666 14.9661C14.8018 15.1309 14.5859 15.2133 14.37 15.2133Z" fill={darkTheme? "#b2abab" : "white"}/>
    <path d="M9 17.4374C8.53363 17.4374 8.15625 17.0596 8.15625 16.5937V15.7502C8.15625 15.2843 8.53363 14.9065 9 14.9065C9.46637 14.9065 9.84375 15.2843 9.84375 15.7502V16.5937C9.84375 17.0596 9.46637 17.4374 9 17.4374Z" fill={darkTheme? "#b2abab" : "white"}/>
    <path d="M3.63037 15.2134C3.41449 15.2134 3.19861 15.131 3.03381 14.9662C2.70422 14.6367 2.70422 14.1025 3.03381 13.773L3.63037 13.1765C3.95996 12.8471 4.4939 12.847 4.82349 13.1766C5.15308 13.5061 5.15308 14.0403 4.82349 14.3698L4.22693 14.9663C4.06213 15.131 3.84625 15.2134 3.63037 15.2134Z" fill={darkTheme? "#b2abab" : "white"}/>
    <path d="M2.25 9.84375H1.40625C0.93988 9.84375 0.5625 9.46594 0.5625 9C0.5625 8.53406 0.93988 8.15625 1.40625 8.15625H2.25C2.71637 8.15625 3.09375 8.53406 3.09375 9C3.09375 9.46594 2.71637 9.84375 2.25 9.84375Z" fill={darkTheme? "#b2abab" : "white"}/>
    <path d="M4.22693 5.07063C4.01105 5.07063 3.79517 4.98833 3.63037 4.82354L3.03381 4.22708C2.70422 3.89759 2.70422 3.36335 3.03381 3.03386C3.3634 2.70427 3.89734 2.70417 4.22693 3.03376L4.82349 3.63022C5.15308 3.95971 5.15308 4.49395 4.82349 4.82344C4.65869 4.98823 4.44281 5.07063 4.22693 5.07063Z" fill={darkTheme? "#b2abab" : "white"}/>
  </g>
  <defs>
...
svg{
    width:${({dt})=>dt === true? "16px" : "20px"};;
  height:${({dt})=>dt === true? "16px" : "20px"};
cursor:pointer;
transform: scale(1);
transition:  all 550ms;
    :hover{
...
svg{
    width:${({dt})=>dt === true? "20px" : "16px"};;
  height:${({dt})=>dt === true? "20px" : "16px"};
cursor:pointer;
transform: scale(1);
transition:  all 550ms;
    :hover{
...
`
const LightIconHolder = styled.div`
    width:40px;
    height:85px;
    border-radius: 20px;
...
const Nav = styled.div`
  border-right: ${({bd})=>bd? "2px solid black" : ""};
  width: 100%;
  display:flex;
  justify-content:center;
  align-items: center;
